...
if __name__ == "__main__":
    ...
    skipped_exercises = [
        exercise.__name__
        for exercise in exercises
        if exercise not in runnable_exercises
    ]

    if skipped_exercises:
        print("Skipping unfinished exercises:")
        for name in skipped_exercises:
            print(f"  - {name}")
        print()

    for ex in runnable_exercises:
        print()
        try:
            ex()
