...
job3_id=$(sbatch --dependency=afterok:${job2_scifact_id}:${job2_labels_id} scripts/slurm/job3_week9_eval.sbatch | awk '{print $4}')
...
echo "  job3_week9:  ${job3_id} (afterok:${job2_scifact_id}:${job2_labels_id})"
